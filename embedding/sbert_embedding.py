...
ITEM_PROFILE_FILE = "manga_describe_embedding.json"
    ...
    if os.path.exists(ITEM_PROFILE_FILE):
        with open(ITEM_PROFILE_FILE, "r", encoding="utf-8") as f:
            try:
                ...
                print("Lỗi đọc file describe_embedding.json, tạo mới.")
    return set(), []
...
def generate_item_profiles():
    ...
    for manga in all_manga:
        ...
        # Ghép title + description
        combined_text = f"{manga['title']} {manga['description']}"
